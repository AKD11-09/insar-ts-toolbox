...
SOURCES = \
	__init__.py \
	insar_ts_toolbox.py insar_ts_toolbox_dialog.py

PLUGINNAME = insar_ts_toolbox
...
EXTRAS = metadata.txt icon.png LICENSE README.md requirements.txt
...
QGISDIR=C:\Users\Ashwin\AppData/Roaming/QGIS/QGIS3/profiles/default/python/plugins
